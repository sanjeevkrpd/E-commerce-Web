                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="d-flex mb-3">
                      ...
                      <div className="info">
                        <a href="#" className="nav-link mb-1">
                          Rucksack Backpack Medium <br /> Line Mounts
                        </a>
                        <strong className="text-dark"> $28.90</strong>
                      </div>
                    </div>
                    ...
                    <div className="d-flex mb-3">
                      ...
                      <div className="info">
                        <a href="#" className="nav-link mb-1">
                          Rucksack Backpack Small <br /> Line Mounts
                        </a>
                        <strong className="text-dark"> $20.90</strong>
                      </div>
                    </div>
                  </div>
                </div>
